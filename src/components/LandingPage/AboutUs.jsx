  ...
  return (
    ...
    >
      ...
      <div className="about-float-content">
        ...
        <div className="about-float-values-area">
          ...
          <div className="about-float-values-carousel">
            {valores.map((valor, i) => (
              <div className="valor-float-card" style={{ borderLeft: `5px solid ${valor.color}`, animationDelay: `${0.27 + i * 0.12}s` }} key={i}>
                <div>
      ...
      <style>{`
        ...
        .about-float-active .about-float-description .fadeUp { opacity: 1; transform: none; }
        ...
        .valor-float-card { background: rgba(248,252,255,0.8); border-radius: 1rem; padding: 0.9rem 1.2rem; transition: all .25s; border-left: 5px solid transparent; }
        .valor-float-card:hover { transform: translateY(-6px); border-left: 5px solid #2563eb; box-shadow: 0 8px 20px rgba(0,0,0,0.1); }
        ...
        @media (max-width: 900px){ .about-float-content { flex-direction: column; gap: 2rem; } }
      `}</style>
    </section>
  );
};
